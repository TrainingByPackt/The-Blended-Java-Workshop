...
public class RecordProgress {
    ...
    private void storeStudentProgress(String firstName, String lastName, long chapterId) {
    ...
    private Long getStudentId(Connection conn, String firstName, String lastName) throws SQLException {
        Long studentId = 1L;
